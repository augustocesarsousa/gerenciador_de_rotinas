...
@Schema(description = "Dados para criação de uma nova instituição bancária")
public record BankCreateRecord(
    ...
    public BankModel toEntity() {
        BankModel entity = new BankModel();
