...
public record RoleResponseRecord(
    ...
    @Schema(description = "Nome de autoridade do perfil no Spring Security", example = "ROLE_ADMIN")
    String authority,
    
    @Schema(description = "Descrição detalhada do papel/função do perfil", example = "Perfil administrativo com acesso total")
    String description
) {
