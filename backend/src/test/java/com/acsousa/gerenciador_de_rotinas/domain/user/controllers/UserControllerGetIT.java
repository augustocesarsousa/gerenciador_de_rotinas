...
public class UserControllerGetIT {
    ...
    @Test
    public void shouldReturnUserFromDatabaseWhenExistingId() throws Exception {
    ...
    @Test
    public void shouldReturnPagedResultsSortedByNameDescWhenFindAll() throws Exception {
    ...
    @Test
    public void shouldReturnPagedResultsFilteredByStatusWhenFindAll() throws Exception {
